...
rota1 = "/newdata3/chf/test_data_rotation_strategy/snr100/6A5L"
os.rename(rota1, rota1 + "_no_wedge")
rota2 = "/newdata3/chf/test_data_rotation_strategy/snr01/6A5L"
os.rename(rota2, rota2 + "_no_wedge")
rota3 = "/newdata3/chf/test_data_rotation_strategy/snr005/6A5L"
os.rename(rota3, rota3 + "_no_wedge")
rota4 = "/newdata3/chf/test_data_rotation_strategy/snr003/6A5L"
os.rename(rota4, rota4 + "_no_wedge")
rota5 = "/newdata3/chf/test_data_rotation_strategy/snr001/6A5L"
os.rename(rota5, rota5 + "_no_wedge")

rota6 = "/newdata3/chf/train_data_rotation_strategy/snr100/6A5L"
os.rename(rota6, rota6 + "_no_wedge")
rota7 = "/newdata3/chf/train_data_rotation_strategy/snr01/6A5L"
os.rename(rota7, rota7 + "_no_wedge")
rota8 = "/newdata3/chf/train_data_rotation_strategy/snr005/6A5L"
os.rename(rota8, rota8 + "_no_wedge")
rota9 = "/newdata3/chf/train_data_rotation_strategy/snr003/6A5L"
os.rename(rota9, rota9 + "_no_wedge")
rota10 = "/newdata3/chf/train_data_rotation_strategy/snr001/6A5L"
