...
# result_dir = "/newdata3/chf/result_iter30/snr100/5LQW"
# data_dir = "/newdata3/chf/result_iter30/snr100/5LQW/data"
result_dir = "/newdata3/chf/result_iter30/snr01/5LQW"
data_dir = result_dir + "/data"
if os.path.exists(result_dir):
    os.rename(result_dir, result_dir+"~")
if not os.path.exists(data_dir):
    os.makedirs(data_dir)
src_file = "/newdata3/chf/train_data/snr01/5LQW.txt"
predict_txt_path = "/newdata3/chf/test_data/snr01/5LQW.txt"
